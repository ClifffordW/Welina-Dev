...
local function OnTakeDamage(inst, data)
	...
	inst.attackerDamageBonuses[attacker] = attackerDamageBonus == nil and damageToAdd
		or attackerDamageBonus + damageToAdd
end

local function GetBonusDamage(inst, victim, damage, weapon)
	return (inst.attackerDamageBonuses == nil or inst.attackerDamageBonuses[victim] == nil) and 0
