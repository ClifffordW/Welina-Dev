...
local assets =
{
    Asset("ANIM", "anim/welina_catcoon_den.zip"),
}
...
--[[
local function checkden_count(den_count)
    local den_count = 0
    for k,v in pairs(Ents) do
        if v.prefab == "welina_catcoonden" then
...
--[[
    ...
    if den_count > 12 then
        
        data.builder.components.talker:Say("There are too many catcoon dens.")
