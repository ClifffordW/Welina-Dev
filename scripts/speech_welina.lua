...
--fallback to speech_wilson.lua 			NO_HEAVY_LIFTING = "only_used_by_wanda",
        ...
        BATHBOMB =
        {
            GLASSED = "It's glasses to hell and back.",
...
--fallback to speech_wilson.lua 	ANNOUNCE_POCKETWATCH_OPEN_PORTAL_DIFFERENTSHARD = "only_used_by_wanda",
	...
	ANNOUNCE_TALK_TO_PLANTS =
	{
        ...
        "Don't you wanna get buried deeper or something?",
	},

	ANNOUNCE_KITCOON_HIDEANDSEEK_START = "Oh let's start, come on!!",
	ANNOUNCE_KITCOON_HIDEANDSEEK_JOIN = "Need help? Sure thing!",
	...
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_ONE_MORE = "There's one more around.",
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_LAST_ONE = "Did i win?",
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_LAST_ONE_TEAM = "Aw, {name} got to the last one first...",
	ANNOUNCE_KITCOON_HIDANDSEEK_TIME_ALMOST_UP = "I need to pick up the pace!",
	...
	ANNOUNCE_KITCOON_FOUND_IN_THE_WILD = "What are you doing here, all alone?",

	ANNOUNCE_TICOON_START_TRACKING	= "Yea, help me find 'em!",
	ANNOUNCE_TICOON_NOTHING_TO_TRACK = "There's nothing around? That can't be!",
	ANNOUNCE_TICOON_WAITING_FOR_LEADER = "I see even you know the hierarchy.",
	ANNOUNCE_TICOON_GET_LEADER_ATTENTION = "Huh, what you want?",
	ANNOUNCE_TICOON_NEAR_KITCOON = "We're around one of those kitts.",
	ANNOUNCE_TICOON_LOST_KITCOON = "Nooo, someone got this one first.",
	ANNOUNCE_TICOON_ABANDONED = "I thought we had something special!",
	ANNOUNCE_TICOON_DEAD = "Oh, that sucks.",

    -- YOTB
    ANNOUNCE_CALL_BEEF = "T-This is my assistant, say hello.",
    ANNOUNCE_CANTBUILDHERE_YOTB_POST = "It's too far from all the fuss.",
    ...
    ANNOUNCE_EYEOFTERROR_FLYAWAY = "I'll find you, i will.",
	...
	DESCRIBE =
	{
        ...
        BOOK_BIRDS = "Birds summeoning? That's infinite food!",
        ...
        FIREPEN = "This isn't how pens work!",
        ...
        WENDY =
        {
            ...
            MURDERER = "You think i w-won't kill a child? Nya-hah!",
            REVIVER = "%s defies death itself... cool.",
            GHOST = "%s, woah, you look j-just like your sister.",
            FIRESTARTER = "I suggest you keep away from t-torches, kid.",
        },
        WOODIE =
        {
            GENERIC = "H-Hello, %s.",
        ...
        WICKERBOTTOM =
        {
            ...
            MURDERER = "Y-You grandma are t-taking things too far.",
            REVIVER = "%s i-is a really r-reliable person.",
